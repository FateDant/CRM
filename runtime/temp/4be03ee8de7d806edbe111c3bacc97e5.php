<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"../application/admin/view/grid/DataGrid.html";i:1532655200;s:76:"D:\ruanjian\wamp\wamp64\www\ThinkPHP\application\admin\view\public\meta.html";i:1532404238;}*/ ?>
...
<body>
	<div class="admissionsGrid-body">
		<div class="admissionsGrid-body-top">
			<span>数据统计-</span> <span><?php echo $school_name; ?></span>
		</div>
		<div class="acount-search">数据搜索</div>
		<table class="search-container">
			<tbody>
				<tr>
					<td><label for="select-school">校区</label>
					</td>
					<td><div id="select-school" class="search-container-list"></div>
					</td>
					<td><label for="select-channel">渠道</label>
					</td>
					<td><div id="select-channel" class="search-container-list"></div>
					</td>
					<td><label for="txtMobile">电话</label>
					</td>
					<td><input id="txtMobile" type="text" placeholder="请输入电话" maxlength="11" validate="n" autocomplete="off" />
					</td>
					<td><label for="select-online">在线咨询师</label>
					</td>
					<td><div id="select-online" class="search-container-list"></div>
					</td>
				</tr>
				<tr>
					<td><label for="select-edu">学历</label>
					</td>
					<td><div id="select-edu" class="search-container-list"></div></td>
					<td><label for="select-stuState">学员状态</label>
					</td>
					<td><div id="select-stuState" class="search-container-list"></div></td>
					<td><label for="select-stuAtt">学员意向</label>
					</td>
					<td><div id="select-stuAtt" class="search-container-list"></div></td>
					<td><label for="select-courseCon">课程顾问</label>
					</td>
					<td><div id="select-courseCon" class="search-container-list"></div></td>
				</tr>
				<tr>
					<td><label for="">咨询日期</label>
					</td>
					<td><input type="text" id="startDate" name="date" /></td>
					<td><label>至</label>
					</td>
					<td><input type="text" id="endDate" name="date" />
					</td>
				</tr>
			</tbody>
		</table>
