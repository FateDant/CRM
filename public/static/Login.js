...
// 	return txtObj.val() == "" ? showErrorTip(txtObj, errMsg) : hideErrorTip(txtObj);
// }
...
// 登录按钮点击事件
    function btnLogin_onclick() {
        ...
        //         // if (btnLogin.hasClass("btnError") || btnLogin.hasClass("btnSuccess") || btnLogin.hasClass("btnDisable"))
        //         //     return;// 退出整个方法
        //         // // 错误统计
        //         // var errCount = 0;
        //         // // 遍历所有输入框
        ...
        $.post("www.baidu.com", {
            ...
            if (json.isSuccess == "true") {
                util.cookie.set("lastLoginName", $("#chkRMW").is(":checked") ? $("#txtUserName").val() : "");
